        ...
        >
          ...
          >
            <Box sx={{ width: { xs: "100%", sm: "60%" } }}>
              ...
              <form onSubmit={handleSubmit} data-aos="zoom-out">
          ...
          >
            {" "}
            <Typography variant="body2" fontWeight={600} data-aos="fade-right">
              Quick Links
            </Typography>
            <NavHashLink
              to={"/#recent-shows"}
            ...
            <NavHashLink to={"/#team"} smoothScroll={true} data-aos="fade-left">
              <Typography variant="body2" color="text.secondary">
                Team
              </Typography>{" "}
            </NavHashLink>{" "}
          ...
          >
            <Typography variant="body2" fontWeight={600} data-aos="fade-left">
              Services
            </Typography>
            <Link
              color="text.secondary"
